...
class ContractCreationTool:
    ...
    def create_widgets(self) -> None:
        ...
        # self.image = ImageTk.PhotoImage(Image.open(r"C:\Users\T590\Seafile\Github ACGF\Grant_Agreement_Tool\etc\select_btn.png"))
        # tk.Button(self.frame, text="Select", image=self.image,command=self.select_word_file, padx=10).grid(row=0, column=2, padx=10, pady=10)

        # create label for progress bar value
        self.progress_bar_value_label_var = tk.StringVar()
        self.progress_bar_value_label = tk.Label(self.frame, textvariable =self.progress_bar_value_label_var, bg="#e8e4e4", font=("Arial", 7), pady=0, padx=0)
        ...
        tk.Button(self.frame, text="Select",command=self.select_word_file, padx=10, **BUTTON_SETTINGS).grid(row=0, column=2, padx=10, pady=10)
        tk.Button(self.frame, text="Select", command=self.select_excel_file, padx=10, **BUTTON_SETTINGS).grid(row=1, column=2, padx=10, pady=10)
        tk.Button(self.frame, text="Select", command=self.select_output_folder, padx=10, **BUTTON_SETTINGS).grid(row=2, column=2, padx=10, pady=10)
        tk.Button(self.frame, text="Load", command=self.load_data, padx=10, **BUTTON_SETTINGS).grid(row=3, column=2, padx=10, pady=10)
        tk.Button(self.frame, text="Generate", command=self.generate_files, padx=10, **BUTTON_SETTINGS).grid(row=5, column=1, padx=10, pady=10)
        tk.Button(self.frame, text="Help", command=self.get_help, padx=10, **BUTTON_SETTINGS).grid(row=3, column=0, padx=10, pady=10)
        ...
        # create table
        tk.Label(self.frame, text="Template Fields", font=("Segoe UI", 9, "bold", "roman", "underline"),**LABEL_SETTINGS).grid(row=7, column=0)
        tk.Label(self.frame, text="Data Fields", font=("Segoe UI", 9, "bold", "roman", "underline"),**LABEL_SETTINGS).grid(row=7, column=1)
    ...
    def select_word_file(self) -> None:
        ...
        Returns:
            None
        """
        self.word_file: filedialog = filedialog.askopenfilename(initialdir=os.getcwd(), title="Select Word file", filetypes=[("Word files", "*.docx")])
    ...
    def select_excel_file(self) -> None:
        ...
        Returns:
            None
        """
        self.excel_file: filedialog = filedialog.askopenfilename(initialdir=os.getcwd(), title="Select Excel file", filetypes=[("Excel files", "*.xlsx")])
